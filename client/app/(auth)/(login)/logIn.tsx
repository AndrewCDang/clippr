...
export function LogIn(){
    const { logInIsOpen, logInClose } = useLogInModal()
    const { registerOpen } = useRegisterModal()
    ...
    const LogInModal = () => {
        return(
        <section className='z-10 relative place-self-center bg-bg p-4 flex flex-col h-fit gap-2 rounded-xl max-w-[400px] w-[80%] min-w-[320px]'>
    ...
    return(
        ...
        <Modal child={<LogInModal/>} isModalOpen={logInIsOpen} modalClose={logInClose}/>
    )
}

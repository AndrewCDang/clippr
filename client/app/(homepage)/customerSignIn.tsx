    ...
    return (
        <div>
        {
            ...
            <main className="flex flex-col justify-center items-center mt-8 mb-16 relative w-full">
                ...
                <aside className="[width:_clamp(360px,25vw+200px,1000px)] flex ">
                    <Link href={'/Appointments'} className="underline text-xl cursor-pointer mx-auto text-light">View Appointment</Link>
                </aside>

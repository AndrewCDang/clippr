...
export default async function Home() {
  ...
  return (
    <main className='flex flex-col items-center'>
          ...
          barber.map((item)=>{
            return (
              <Link className='home-barber' href={`/barber/${item.id}`}>
                  ...
                  <img className='home-b-image' src={`${item.profile}`}></img>
              </Link>
      ...
      <section className="w-[80%] flex border-primrary pb-24  gap-2 mx-auto margin-0 flex justify-center">
        <article className='w-1/3'>
          <img src={"/clippr_shop.png"} style={{backgroundSize:'cover'}} className='bg-light h-48 w-48 mx-auto rounded-2xl '>
          </img>
          <div className='text-center w-[90%] mx-auto mt-2'>
        ...
        <article className='w-1/3'>
          <img src={"/clippr_home.png"} style={{backgroundSize:'cover'}} className='bg-light h-48 w-48 mx-auto rounded-2xl '>
          </img>
          <div className='text-center w-[90%] mx-auto mt-2'>
        ...
        <article className='w-1/3'>
          <img src={"/clippr_mobile.png"} style={{backgroundSize:'cover'}} className='bg-light h-48 w-48 mx-auto rounded-2xl '>
          </img>
          <div className='text-center w-[90%] mx-auto mt-2'>
      ...
      <section className='w-[100%] m-8 flex flex-wrap gap-4 justify-center items-center'>
        <div className='flex-grow-[100%] max-w-[600px]  bg-light-2 rounded-xl overflow-hidden relative'>
          <img src='https://images.unsplash.com/photo-1593702282967-96c9f195befa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2940&q=80' className='object-cover'></img>
        </div>
